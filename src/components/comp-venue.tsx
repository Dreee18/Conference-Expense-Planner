...
function VenueComp() {
    ...
    return (
        ...
        <div className="content-container">
            <h1 className="title" id="h1_venue">Venue Room <br/> Selection</h1>

            <div className="item-container">
                <ItemCard image = {ConferenceRoom} title = "Conference Room" capacity = {15} price = {1500}/>
                <ItemCard image = {AuditoriumHall} title = "Auditorium Hall" capacity = {200} price = {5500}/>
                <ItemCard image = {PresentationRoom} title = "Presentation Room" capacity = {50} price = {3500}/>
                <ItemCard image = {LargeMeetingRoom} title = "Large Meeting Room" capacity = {10} price = {1000}/>
                <ItemCard image = {SmallMeetingRoom} title = "Small Meeting Room" capacity = {5} price = {800}/>
            </div>
        </div>
        </>
    );
